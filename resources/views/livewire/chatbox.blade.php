                                ...
                                @foreach ($users as $user)
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info">
                                                <input type="hidden" wire:model="user_adress_id" name="user_id"
                                                    value="{{ $user->user_id }}" />
                                                <span
                                                    wire:click.prevent="chat({{ $user->id }})">{{ $user->name }}</span>
                        ...
                        <form wire:submit.prevent="save">
                            <div class="card-footer type_msg">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" wire:model="messages"
